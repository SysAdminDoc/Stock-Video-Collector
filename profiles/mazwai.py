"""Built-in Mazwai/Magnific site profile and contract fixtures."""

PROFILE_NAME = 'Mazwai'
CONTRACT = {
    'catalog_urls': [
        'https://mazwai.com/stock-video-footage',
    ...
    'excluded_urls': [
        'https://www.magnific.com/ai/image-generator',
        'https://www.magnific.com/pricing',
    ],
    'video_urls': [
        {'url': 'https://img.magnific.com/videos/sample_3445332.mp4', 'allowed': True},
        {'url': 'https://www.magnific.com/ai/image-generator', 'allowed': False},
    ],
}
...
def build(SiteProfile):
    ...
    return SiteProfile(
        'Mazwai',
        description='Mazwai legacy route now resolves to Magnific/Freepik royalty-free video catalog',
        domains=[
            'mazwai.com', 'www.mazwai.com',
        ...
        catalog_patterns=['/stock-video-footage', '/videos', '/free-videos', '/video', '/free-video'],
